...
export class VillageRoutes {
  ...
  private configureRoutes() {
    this.router.get(
      "/",
      authMiddleware,
      this.villageController.getVillages.bind(this.villageController)
    );
    this.router.post(
      "/",
      authMiddleware,
      ...
      this.villageController.createVillage.bind(this.villageController)
    );
    this.router.patch(
      "/:id",
      authMiddleware,
      ...
      this.villageController.updateVillage.bind(this.villageController)
    );
    this.router.delete(
      "/:id",
      authMiddleware,
      authorizeRoles(Role.ADMIN),
      this.villageController.deleteVillage.bind(this.villageController)
    );
    return this.router;
  }
