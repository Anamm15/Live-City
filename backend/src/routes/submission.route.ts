...
export class SubmissionRoutes {
   ...
   private configureRoutes() {
      ...
      this.router.post('/', authMiddleware, upload.single('file'), validate(CreateSubmissionSchema), this.submissionController.createSubmission.bind(this.submissionController));
